...
- (IBAction)filterButtonPressed {
    [self.navigationController pushViewControllerWithStoryboardID:@"Filter" animated:YES data:_filterData];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.navigationController pushViewControllerWithStoryboardID:@"Personal" animated:YES data:data];
}
...
- (void)registerNotifications {
    ...
    [center addObserver:self selector:@selector(didLogout) name:kNotificationTypeLogout object:nil];
}
...
- (void)fetchObjectsOnPage:(NSInteger)page refresh:(BOOL)refresh cache:(BOOL)cache {
    ...
    [helper sendRequestWithURLString:kURLTypeList parameters:params success:^(NSURLSessionDataTask *task, NSDictionary *response) {
...
- (void)successWithTask:(NSURLSessionDataTask *)task response:(NSDictionary *)response refresh:(BOOL)refresh {
